...
const scroll = () => {
  fx1Titles.forEach(title => {
    ...
    _gsap.gsap.fromTo(chars, {
      ...
      opacity: 0,
      scale: 0.6,
      rotationZ: () => _gsap.gsap.utils.random(-20, 20)
    }, {
      ease: "power4",
      opacity: 1,
      scale: 1,
  ...
  fx5Titles.forEach(title => {
    ...
    _gsap.gsap.fromTo(chars, {
      "will-change": "opacity, transform",
      opacity: 0,
      xPercent: () => _gsap.gsap.utils.random(-200, 200),
      yPercent: () => _gsap.gsap.utils.random(-150, 150)
    }, {
      ease: "power1.inOut",
      opacity: 1,
      xPercent: 0,
  ...
  fx8Titles.forEach(title => {
    ...
    chars.forEach((char, position) => {
      ...
      _gsap.gsap.fromTo(char, {
        ...
        onComplete: () => _gsap.gsap.set(char, {
  ...
  fx14Titles.forEach(title => {
    const chars = title.querySelectorAll(".char");
    _gsap.gsap.timeline().fromTo(title, {
      "will-change": "transform",
      xPercent: 100
    }, {
      ease: "none",
