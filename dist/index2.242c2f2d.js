...
var l = ["duration", "easing"],
  ...
  c = exports.default = /*#__PURE__*/function (t) {
    var i, r;
    function l(i) {
      var o,
        r,
...
},{"tiny-emitter":"../node_modules/tiny-emitter/index.js","virtual-scroll":"../node_modules/virtual-scroll/lib/virtualscroll.js"}],"../node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
},{"./Observer.js":"../node_modules/gsap/Observer.js"}],"../node_modules/splitting/dist/splitting.css":[function(require,module,exports) {
...
const scroll = () => {
  ...
  fx17Titles.forEach(title => {
    ...
    chars.forEach(char => _gsap.gsap.set(char.parentNode, {
      perspective: 1000
    }));
    _gsap.gsap.fromTo(chars, {
      'will-change': 'opacity, transform',
      opacity: 0,
      rotateX: () => _gsap.gsap.utils.random(-120, 120),
      z: () => _gsap.gsap.utils.random(-200, 200)
    }, {
      ease: 'none',
      opacity: 1,
      rotateX: 0,
  ...
  fx21Titles.forEach(title => {
    ...
    for (const word of words) {
      ...
      _gsap.gsap.fromTo(chars, {
        ...
        z: () => _gsap.gsap.utils.random(-1500, -600),
        rotationX: () => _gsap.gsap.utils.random(-500, -200)
      }, {
        ease: 'power1.inOut',
        opacity: 1,
        y: 0,
  ...
  fx27Titles.forEach(title => {
    const words = [...title.querySelectorAll('.word')];
    words.forEach(word => _gsap.gsap.set(word.parentNode, {
      perspective: 1000
    }));
    _gsap.gsap.fromTo(words, {
      'will-change': 'opacity, transform',
      z: () => _gsap.gsap.utils.random(500, 950),
      opacity: 0,
      xPercent: pos => _gsap.gsap.utils.random(-100, 100),
      yPercent: pos => _gsap.gsap.utils.random(-10, 10),
      rotationX: () => _gsap.gsap.utils.random(-90, 90)
    }, {
      ease: 'expo',
      opacity: 1,
      rotationX: 0,
...
var b=require("../node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("../node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([]).then(function(){require("js/index2.js");});
